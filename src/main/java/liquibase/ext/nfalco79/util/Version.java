 ...
 * <li>Build version. A non-negative integer.</li>
...
public class Version implements Comparable<Version> {
    ...
    private void validate() {
        if (major < 0) {
            throw new IllegalArgumentException("invalid version \"" + toString() + "\": negative number \"" + major + "\"");
        }
        if (minor < 0) {
            throw new IllegalArgumentException("invalid version \"" + toString() + "\": negative number \"" + minor + "\"");
        }
        if (micro < 0) {
            throw new IllegalArgumentException("invalid version \"" + toString() + "\": negative number \"" + micro + "\"");
        }
        for (char ch : qualifier.toCharArray()) {
            ...
            throw new IllegalArgumentException("invalid version \"" + toString() + "\": invalid qualifier \"" + qualifier + "\"");
        }
    }
