...
public class VersionRange {
     ...
     *
     * @param minInclude if min version is included.
     ...
     * @param maxInclude if max version is included.
     * @throws IllegalArgumentException If the arguments are invalid.
     */
    public VersionRange(boolean minInclude, Version leftEndpoint, Version rightEndpoint, boolean maxInclude) {
        if (leftEndpoint == null) {
            throw new IllegalArgumentException("null leftEndpoint argument");
        }
        leftClosed = minInclude;
        rightClosed = maxInclude;
        left = leftEndpoint;
        right = rightEndpoint;
        empty = isEmpty0();
    }
